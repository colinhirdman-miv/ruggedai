...
Use the 'edit_doc' tool to save the reformatted document when done.
"""
...
def summarize_document(
    ...
    prompt = f"""
Your goal is to summarize the contents of a document clearly and concisely.
...
Use the 'read_doc_contents' tool to read the document, then provide a brief summary.
"""
    return [base.UserMessage(prompt)]
