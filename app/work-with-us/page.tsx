      ...
      <section className="py-24 px-6 bg-brand-dark">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* 1:1 Consulting */}
            <div className="border border-brand-red bg-[#130000] p-10 flex flex-col">
            ...
            {/* Rugged Builds */}
            <div className="border border-[#1a1a1a] bg-brand-dark p-10 flex flex-col">
              <h3 className="font-display font-black text-3xl uppercase text-white mb-2">
                Rugged Builds
              </h3>
              <div className="mb-6">
              ...
              <Link
                href="/apply"
                className="font-display font-black text-sm uppercase tracking-widest border border-brand-iron text-brand-iron px-6 py-3 text-center hover:border-white hover:text-white transition-colors"
              >
                Get Started →
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-px bg-[#1a1a1a]">
            {[
              ...
              <div key={s.step} className="bg-brand-black px-8 py-8 flex gap-8 items-start">
                <span
                ...
                <div>
                  <h3 className="font-display font-black text-xl uppercase text-white mb-2">{s.title}</h3>
                  <p className="text-brand-steel text-sm leading-relaxed">{s.description}</p>
                </div>
              </div>
            ))}
          </div>
