      ...
      <section className="pt-36 pb-16 px-6 bg-brand-black">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[#9CA3AF] text-base md:text-lg max-w-2xl mb-8 leading-relaxed">
            Three weeks, live and hands-on, alongside a small group of electrical contractors facing the same things you are. You&apos;ll cut through the hype, learn how AI actually works in plain English, and put it to work where it counts in your shop. No code and no tech background required — if you can describe how your shop runs, you can do this.
          </p>
