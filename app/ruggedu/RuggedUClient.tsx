...
const faqs = [
  ...
  },
  {
    ...
    a: "The next cohort runs over three Tuesdays — June 30, July 7, and July 21, 2026 — from 10:30am to noon CT. Fill out the form to reserve your spot. If the timing doesn't work, let us know and we'll get you into the next one.",
  },
];
      ...
      <section className="pt-36 pb-16 px-6 bg-brand-black">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[#9CA3AF] text-base md:text-lg max-w-2xl mb-8 leading-relaxed">
            Three weeks, live and hands-on, alongside a small group of trades pros facing the same things you are. You&apos;ll cut through the hype, learn how AI actually works in plain English, and put it to work where it counts in your business. No code and no tech background required — if you can describe how your business runs, you can do this.
          </p>
      ...
      <div className="bg-brand-red px-6 py-4">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row justify-center items-center gap-x-6 gap-y-3 text-white">
          <p className="font-display font-bold text-sm uppercase tracking-widest">
            Next Cohort Starts Tuesday, June 30
          </p>
      ...
      <section className="py-24 px-6 bg-white border-t border-brand-iron/20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#374151] text-base md:text-lg max-w-2xl mb-12 leading-relaxed">
            This isn&apos;t a lecture series. Over three weeks you learn to actually use Claude — the AI you&apos;ll build on — and put it to work on the stuff that eats your time. You leave with it running plus the know-how to keep building.
          </p>
